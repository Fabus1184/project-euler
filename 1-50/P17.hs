module P17 (numberLetterCounts) where
...
count :: Integral a => String -> a
count = genericLength . filter isAlpha

numberLetterCounts :: Integer
numberLetterCounts = count . mconcat . map spell $ [1 .. 1000]